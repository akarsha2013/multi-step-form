...
// Next/Back buttons share the same id across steps (only one is ever
// visible at a time), so we grab every occurrence with querySelectorAll
// and wire each one up individually, in document order (step1, step2, step3...).
const nextButtons = document.querySelectorAll("#next-button");
const backButtons = document.querySelectorAll("#back-button");

const nextBtn = nextButtons[0];       // Step 1 -> Step 2
const step2NextBtn = nextButtons[1];  // Step 2 -> Step 3
const step3NextBtn = nextButtons[2];  // Step 3 -> Step 4

const backBtn2 = backButtons[0]; // Step 2 -> Step 1
const backBtn3 = backButtons[1]; // Step 3 -> Step 2
const backBtn4 = backButtons[2]; // Step 4 -> Step 3
